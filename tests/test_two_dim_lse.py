...
class TestBasicLSE(unittest.TestCase):
    ...
    def test_linear(self):
        ...
        for i, (lse_k, lse_b) in methods.search_lse2(
                expression=sym_expr,
                parameters=(sym_k, sym_b),
                values={sym_x: x},
        ...
        self.assertAlmostEqual(real_k, lse_k, places=1)
        self.assertAlmostEqual(real_b, lse_b, places=1)
    ...
    def test_exponential(self):
        ...
        # use basic estimates as init estimates for LSE
        for i, (lse_a, lse_alpha) in methods.search_lse2(
                expression=sym_expr,
                parameters=(sym_a, sym_alpha),
                values={sym_x: x},
                result_values={sym_y: y},
        ...
        self.assertAlmostEqual(real_a, lse_a, places=1)
        self.assertAlmostEqual(real_alpha, lse_alpha, places=1)
    ...
    def test_sinusoidal(self):
        ...
        # use basic estimates as init estimates for LSE
        for i, (lse_a, lse_t) in methods.search_lse2(
                expression=sym_expr,
                parameters=(sym_a, sym_t),
                values={sym_x: x},
                result_values={sym_y: y},
        ...
        self.assertAlmostEqual(real_a, lse_a, places=1)
        self.assertAlmostEqual(real_t, lse_t, places=1)
